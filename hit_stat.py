...
def load_and_split(sn_limit, bg_limit, detector):
    '''
    Load the signal and backgrounds and split them insto train adn efficiency computation sets
    '''
    ...
    # ENERGY LIMIT TO TRAIN THE BDT (TODO: add to parameters.py)
    ENERGY_LIMIT = 30
    ...
    sn_train_hit_list_per_event = sn_train_hit_list_per_event[sn_train_info_per_event[:, 0] < ENERGY_LIMIT]
    sn_train_info_per_event = sn_train_info_per_event[sn_train_info_per_event[:, 0] < ENERGY_LIMIT]
    ...
    return sn_hit_list_per_event, sn_train_hit_list_per_event, sn_info_per_event, sn_train_info_per_event, bg_hit_list_per_event, bg_train_hit_list_per_event, bg_length
...
def main():
    ...
    sn_hit_list_per_event, sn_train_hit_list_per_event, sn_info_per_event, sn_train_info_per_event, bg_hit_list_per_event, bg_train_hit_list_per_event, bg_length =\
        load_and_split(SN_FILE_LIMIT_SEARCH, BG_FILE_LIMIT_SEARCH, detector)
